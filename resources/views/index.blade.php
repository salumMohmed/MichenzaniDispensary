...
<head>
  ...
  <title>Michenzani Dispensary</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="#" class="logo me-auto"><img src="assets/img/logo2.png" alt=""></a>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-right">
            <img src="assets/img/mp.about.jpeg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>Michenzani Dispensary - Mwembetanga-Zanzibar.</h3>
            <p class="fst-italic">
...
The aim is to give the best and appropriate health care to  the local community and foreigners as well due to the main centre area  of Tourism in Zanzibar 
    ...
    <section id="services" class="services services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>Our services are available 24 hrs except of specialized cases.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon"><i class="fas fa-dna"></i></div>
            <h4 class="title"><a href="">ENT Consultation</a></h4>
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              <select name="doctor" id="doctor" class="form-select">
                ...
                <option value="Doctor 1">Dr Mohamed Juma Salum</option>
                <option value="Doctor 2">Dr Juma Salum Mbwana (Mambi)</option>
                <option value="Doctor 3">Dr Juma Muhsin Ali</option>
                <option value="Doctor 3">Dr Mfuko </option>
              </select>
            </div>
          </div>
          ...
          <div class="col-lg-8">
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                ...
                <!-- <img src="assets/img/mp.mission.jpg" alt="" class="img-fluid"> -->
            
                  <Ol style="list-style:none;">
                    <li><i class="bi bi-check-circle"></i> To ensure the patient satisfactory  and safety are our first priorities.</li>
                    <li><i class="bi bi-check-circle"></i> To ensure that our community gets better health care services in affordable and best charges.</li>
                    <li><i class="bi bi-check-circle"></i> To provide the best health care to the people.</li>
                    <li><i class="bi bi-check-circle"></i> To provide the best access to the refferal hospital.</li>
                    <li><i class="bi bi-check-circle"></i> To provide the best health care to the people.</li>
                    <li><i class="bi bi-check-circle"></i> To upgrade from primary care to the speciality care services.</li>
                  </Ol>
              </div>
              <div class="tab-pane" id="tab-2">
                <h3>Vision</h3>
                <!-- <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde sonata raqer a videna mareta paulona marka</p> -->
                <!-- <img src="assets/img/mp.vision.jpg" alt="" class="img-fluid"> -->
                <p>
                  To create accessibility to the community for good and quality health care services.
                </p>
              </div>
              <div class="tab-pane" id="tab-3">
                <h3>Right of Patients</h3>
                <!-- <p class="fst-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde sonata raqer a videna mareta paulona marka</p> -->
                <!-- <img src="assets/img/departments-3.jpg" alt="" class="img-fluid"> -->
                <ol style="list-style:none;">
                  <li><i class="bi bi-check-circle"></i>	Right to appropriate medical care and humane treatment.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to infromed conset.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to privacy and confidentiality.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to information.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to choose health care  provider and facility.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to self determination.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to religions belief.</li>
                  <li><i class="bi bi-check-circle"></i>  Right to medical records.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to leave.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to refuse participation in medical research.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to correspondence and to receive visitors.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to express grievances.</li>
                  <li><i class="bi bi-check-circle"></i>	Right to be infromed of his rights and oligations as a patient.</li>
                  </ol>
              </div>
...
It's true that you care a lot, I'm happy with your services, I really like the way you served me
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="400">
              <div class="member-img">
                <img src="assets/img/doctors/1.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="gallery-slider swiper">
          <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/gallery/9.jpg"><img src="assets/img/gallery/9.jpg" class="img-fluid" alt=""></a></div>
          </div>
          <div class="swiper-pagination"></div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="400">
              <span class="advanced">Offer 15%</span>
              <h3>INVESTIGATION</h3>
              <!-- <h4><sup>$</sup>49<span> / month</span></h4> -->
              <ul>
                <li>Blood Sugar: -----  <span class="price">5$</span></li>
                <li>Blood Group: -----  <span class="price">10$</span></li>
                <li>Haemoglobin (Hb): -----  <span class="price">10$</span></li>
                <li>HIV: -----  <span class="price">10$</span></li>
                <li>Hepatitid C: -----  <span class="price">15$</span></li>
                <li>Hepatitid B: -----  <span class="price">15$</span></li>
                <li>H.Pyloro: -----  <span class="price">10$</span></li>
                <li>Urinary Pregnancy Test (UPT): -----  <span class="price"> 5$</span></li>
                <li>Urinalysus: -----  <span class="price">5$</span></li>
                <li>Malaria: -----  <span class="price"> 5$</span></li>
                <li>ECG: -----  <span class="price">20$</span></li>
              </ul>
              <div class="btn-wrap">
                <a href="#appointment" class="btn-buy">Book Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="400">
              <span class="advanced">Offer 15%</span>
              <h3>CONSULTATIONS</h3>
              <!-- <h4>Will Provided 50<sup>%</sup>off</h4> -->
              <ul>
                <li>General Consultaion: -----  <span class="price">50$</span></li>
                <li>Home Consultaion: -----  <span class="price">10$</span></li>
                <li>Dermatologist Consultaion: -----  <span class="price">60$</span></li>
                <li>ENT Consultaion: -----  <span class="price">70$</span></li>
              </ul>
              <div class="btn-wrap">
                <a href="#appointment" class="btn-buy">Book Now</a>
              </div>
           ...
           <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="400">
              ...
              <!-- <h4>Will Provided 50<sup>%</sup>off</h4> -->
              <ul>
                <li>Injection IM (No Syringe): -----  <span class="price">2$</span></li>
                <li>Injection IM (with Syringe): -----  <span class="price">3$</span></li>
                <li>Injection IV (No Syringe + Butterfly): -----  <span class="price">2$</span></li>
                <li>Injection IV (with Syringe + Butterfly): -----  <span class="price">3$</span></li>
                <li>Normal Dressing: -----  <span class="price">5$</span></li>
                <li>Multiolpe Dressing: -----  <span class="price">10$</span></li>
                <li>Operation Dressing: -----  <span class="price">10$</span></li>
                <li>Suture Removal: -----  <span class="price">5$</span></li>
                <li>Suturing: -----  <span class="price">20$</span></li>
                <li>Incision and dranage: -----  <span class="price">10$</span></li>
                <li>Circumscission: -----  <span class="price">30$</span></li>
              </ul>
              <div class="btn-wrap">
                <a href="#appointment" class="btn-buy">Book Now</a>
              </div>
    ...
    <section id="contact" class="contact">
      ...
      <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.748222372919!2d39.19534181375584!3d-6.164463395536947!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x185cd168ade5ed49%3A0xd3d0b877c6205058!2smichenzani%20dispensary!5e0!3m2!1sen!2stz!4v1668358410806!5m2!1sen!2stz" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>Email Us</h3>
                  <p>michenzanidispensary@gmail.com<br>info@mp.co.tz</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>Call Us</h3>
                  <p>+255 713 863 010<br>+255 629 137 170</p>
                </div>
              </div>
            </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Michenzani Dispensary</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
